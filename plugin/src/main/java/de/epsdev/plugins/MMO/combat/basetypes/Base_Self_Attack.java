...
public abstract class Base_Self_Attack extends Attack {
    public Base_Self_Attack(String name, long reloadTime, float baseDmg, float baseHeal, float manaCastCost, float liveCastCost, String description) {
