...
public abstract class Base_Range extends Attack {
    public Base_Range(String name, long reloadTime, float baseDmg, float baseHeal, float manaCastCost, float liveCastCost, String description) {
