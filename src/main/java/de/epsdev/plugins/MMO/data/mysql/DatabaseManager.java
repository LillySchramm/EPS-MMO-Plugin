...
public class DatabaseManager {
    ...
    public void init() {
        ...
        mysql.createTableIfNotExists("eps_regions", "npc","`ID` INT NOT NULL AUTO_INCREMENT , `NAME` TEXT NOT NULL, `SCRIPT` TEXT NOT NULL , `POS` TEXT NOT NULL, `SKIN` TEXT NOT NULL, PRIMARY KEY (`ID`)");
